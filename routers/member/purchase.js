...
router.get(
    ...
    async (req, res) => {
        try {
            ...
            const email_link = `mailto:Eric.Nelson@harker.org?subject=Receipt for Reimbursement (PR #${purchase.purchase_id})&body=Hi Dr. Nelson,%0A%0AHere's the receipt for reimbursement for PR #${purchase.purchase_id} (https://robotics.harker.org/member/purchase/view/${purchase.purchase_id}).%0A%0AThanks,%0A${auth.info.name}`;
